...
class TestCustomerWorkflow:
    ...
    async def test_complete_customer_journey(self):
        ...
        catalog_response = await product_use_case.get_products_by_category(
            catalog_request
        )
        ...
        # Step 3: Add to cart
        cart_request = AddToCartRequest(telegram_id=123456789, product_id=1, quantity=2)
...
class TestErrorHandlingIntegration:
    ...
    def test_error_reporter_integration(self):
        ...
        business_error = BusinessLogicError(
            message="Invalid product selection", error_code="INVALID_PRODUCT"
        )
