...
from src.application.use_cases.order_status_management_use_case import (
...
class TestOrderAnalyticsUseCase:
        ...
        return [
            {
                ...
                "created_at": today,
                "items": [
                    {"product_name": "Kubaneh", "quantity": 2, "total_price": 50.0}
                ],
            },
            {
                "id": 2,
                ...
                "items": [
                    {"product_name": "Hilbeh", "quantity": 1, "total_price": 75.0}
                ],
            },
            {
                "id": 3,
                ...
                "created_at": today,
                "items": [
                    {"product_name": "Kubaneh", "quantity": 1, "total_price": 30.0}
                ],
            },
        ]
    ...
    @pytest.mark.asyncio
    async def test_get_daily_summary_success(
        self, analytics_use_case, mock_repositories, sample_orders
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_daily_summary_empty_orders(
        self, analytics_use_case, mock_repositories
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_daily_summary_with_specific_date(
        self, analytics_use_case, mock_repositories, sample_orders
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_weekly_trends_success(
        self, analytics_use_case, mock_repositories, sample_orders
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_popular_products_success(
        self, analytics_use_case, mock_repositories, sample_orders
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_customer_insights_success(
        self, analytics_use_case, mock_repositories, sample_orders, sample_customers
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_business_overview_success(
        self, analytics_use_case, mock_repositories, sample_orders, sample_customers
    ):
    ...
    def test_format_analytics_report_success(
        self, analytics_use_case, mock_repositories, sample_orders, sample_customers
    ):
        ...
        overview = {
            ...
            "popular_products": [{"product_name": "Kubaneh", "order_count": 10}],
            "customer_insights": {
                "total_customers": 20,
...
class TestOrderCreationUseCase:
    ...
    @pytest.mark.asyncio
    async def test_create_order_customer_not_found(
        self, order_creation_use_case, mock_repositories, sample_order_request
    ):
    ...
    async def test_create_order_delivery_without_address(
        ...
        request = CreateOrderRequest(
            telegram_id=123456789, delivery_method="delivery", delivery_address=None
        )
    ...
    @pytest.mark.asyncio
    async def test_create_order_pickup_method(
        self,
        order_creation_use_case,
        mock_repositories,
        sample_customer,
        ...
        request = CreateOrderRequest(telegram_id=123456789, delivery_method="pickup")
    ...
    @pytest.mark.asyncio
    async def test_create_order_repository_failure(
        self,
        order_creation_use_case,
        mock_repositories,
        sample_customer,
    ...
    @pytest.mark.asyncio
    async def test_create_order_admin_notification_failure(
        self,
        order_creation_use_case,
        mock_repositories,
        sample_customer,
        ...
        order_repo.create_order = AsyncMock(return_value=order_data)
        admin_service.notify_new_order = AsyncMock(
    ...
    async def test_create_order_exception_handling(
        ...
        customer_repo.find_by_telegram_id = AsyncMock(
...
class TestOrderStatusManagementUseCase:
    ...
    def status_management_use_case(self, mock_repositories):
        ...
        return OrderStatusManagementUseCase(
            order_repo, customer_repo, admin_service, customer_service
        )
    ...
    async def test_update_order_status_success(
        ...
        # Execute
        result = await status_management_use_case.update_order_status(
            1, "confirmed", 999
        )
    ...
    async def test_update_order_status_order_not_found(
        self, status_management_use_case, mock_repositories
    ):
    ...
    async def test_update_order_status_invalid_transition(
        self, status_management_use_case, mock_repositories, sample_order_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_order_status_repository_failure(
        self, status_management_use_case, mock_repositories, sample_order_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_pending_orders_success(
        self,
        status_management_use_case,
        mock_repositories,
        sample_order_data,
    ...
    def test_status_transition_validation(self, status_management_use_case):
        ...
        # Valid transitions
        assert (
            status_management_use_case._is_valid_status_transition(
                "pending", "confirmed"
            )
            is True
        )
        ...
        assert (
            status_management_use_case._is_valid_status_transition("ready", "completed")
            is True
        )
        ...
        assert (
            status_management_use_case._is_valid_status_transition("pending", "pending")
            is False
        )

    def test_create_order_info_from_data(
        self, status_management_use_case, sample_order_data, sample_customer
    ):
        """Test creating OrderInfo from order data"""
        result = status_management_use_case._create_order_info(
            sample_order_data, sample_customer
        )
    ...
    @pytest.mark.asyncio
    async def test_status_management_error_handling(
        self, status_management_use_case, mock_repositories
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_orders_by_status_empty_results(
        self, status_management_use_case, mock_repositories
    ):
