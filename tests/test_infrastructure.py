...
class TestBotSecurityManager:
    ...
    def test_rate_limit_different_users(self):
        ...
        is_allowed1, error_msg1 = security_manager.check_request_allowed(
            12345, "general"
        )
        is_allowed2, error_msg2 = security_manager.check_request_allowed(
            67890, "general"
        )
    ...
    def test_message_validation(self):
        ...
        assert (
            is_valid is False or is_valid is True
...
class TestSecurityValidator:
    ...
    def test_validate_phone_number(self):
        ...
        valid_phones = ["+972501234567", "0501234567", "050-123-4567"]
...
class TestErrorHandler:
    ...
    def test_error_reporter_basic(self):
        ...
        error = BusinessLogicError(message="Test error", error_code="TEST_ERROR")
