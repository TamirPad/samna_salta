...
def get_main_menu_keyboard():
    ...
    keyboard = [
        ...
        [
            ...
            InlineKeyboardButton("🥘 Hawaij soup spice", callback_data="menu_hawaij_soup")
        ],
        [
            InlineKeyboardButton("☕ Hawaij coffee spice", callback_data="menu_hawaij_coffee"),
...
def get_kubaneh_oil_keyboard(kubaneh_type: str):
    ...
    keyboard = [
        [
            InlineKeyboardButton("Olive oil", callback_data=f"kubaneh_{kubaneh_type}_olive_oil"),
            InlineKeyboardButton("Samneh", callback_data=f"kubaneh_{kubaneh_type}_samneh")
        ],
        [
...
def get_direct_add_keyboard(product_name: str):
    ...
    keyboard = [
        [
            InlineKeyboardButton("➕ Add to cart", callback_data=f"add_{product_name.lower().replace(' ', '_')}")
        ],
        [
            InlineKeyboardButton("ℹ️ Info", callback_data=f"info_{product_name.lower().replace(' ', '_')}")
        ],
        [
            InlineKeyboardButton("⬅️ Back to main menu", callback_data="menu_main")
        ]
...
def get_hilbeh_menu_keyboard():
    ...
    if is_hilbeh_available():
        ...
        keyboard = [
            [
                InlineKeyboardButton("❌ Not available today (Wed-Fri only)", callback_data="hilbeh_unavailable")
            ],
            [
                InlineKeyboardButton("ℹ️ Info", callback_data="info_hilbeh")
            ],
...
def get_delivery_method_keyboard():
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton("🚚 Delivery (+5 ILS)", callback_data="delivery_delivery")
        ]
    ]
...
def get_order_confirmation_keyboard():
    ...
    keyboard = [
        [
            InlineKeyboardButton("👍 Yes, details are correct", callback_data="order_confirm_yes")
        ],
        [
            InlineKeyboardButton("✏️ No, I want to edit", callback_data="order_confirm_no")
        ]
    ]
